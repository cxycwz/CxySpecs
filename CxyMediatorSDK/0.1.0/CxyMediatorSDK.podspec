...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'CxyMediatorSDK/Classes/CxyMediatorKit.framework/Headers/*.{h}'
  s.vendored_frameworks = 'CxyMediatorSDK/Classes/CxyMediatorKit.framework'
  s.public_header_files = 'CxyMediatorSDK/Classes/CxyMediatorKit.framework/Headers/*.{h}'
